...
<html>
 ...
 String name=null,description=null, brand=null, size=null,imageurl=null,stock=null;
 ...
 try
 {
		...
		<div id = "item1" class = "items"><a href=""><img src = "<%=imageurl%>" height="450px"></img></a><div class = "description"><a><%=name %></a><a>price: <%=price %></a><p><%=description%></p><span id = "buynow"><a href = "#">BUY NOW</a></span><div class="addtocard"><a href = "javascript:void(0)" onclick="addtocart('<%=table %>','<%=pid%>')">ADD TO CART</a></div></div></div>
